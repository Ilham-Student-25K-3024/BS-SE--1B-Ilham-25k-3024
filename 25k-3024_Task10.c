...
int main(){
		...
		case 3:
			...
			if(input_topping=='y'){
				if (input_crust==1){
					...
					printf("Your total is $22.05 with additional $2 for stuffed crust and extra cheese and 10%% discount, you get free garlic bread");
				}else{
					printf("\nInvalid input");
				}
			}else {
				if (input_crust==1){
					...
					printf("Your total is $20.70 with additional $2 for stuffed crust with 10%% discount, you get free garlic bread");
				}else{
					printf("\nInvalid input");
				}
			}}else {
				if (input_crust==1){
					...
					printf("Your total is $23 with additional $2 for stuffed crust, you get free garlic bread.");
				}else{
					printf("\nInvalid input");
				}
			}}else{
	...
	printf("\ndo u want delivery?1.pickup 2.delivery");
	scanf("%c",&del);
	switch(del){
		case 1:
			printf("no extra charges will be added");
			break;
		case 2:
			printf("$3 will be added");
			break;
		default:
			printf("\nInvalid");
	}
