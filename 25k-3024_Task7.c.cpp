#include<stdio.h>
int main(){
	int user_input,input_crust,input_time,std_id;
	char input_topping;
	...
	switch(user_input){
		case 1:
			...
			if(input_topping=='y'){
			if (input_crust==1){
				printf("your total is $8.55 with 10%% discount");
			}else if(input_crust==2){
				printf("Your total is $9.45 with additional $1 for thin crust and $1.50 for cheese and 10%% discount");
			}else if(input_crust==3){
				printf("Your total is $10.35 with additional $2 for stuffed crust and $1.50 for cheese and 10%% discount");
			}else{
				printf("\nInvalid input");
			}
		}
